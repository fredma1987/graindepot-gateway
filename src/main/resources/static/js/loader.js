(function () {
	...
	NAV_METADATA[NAV_TYPE.leftnav] = {
			...
			dataJs: "//main.qcloudimg.com/scripts/qccomponents/leftnav.53c0f5ac0875a24b3576821316c95ea2.js",
	};
	...
	if(availableNavs.length === 0){
		console.warn('qcmain::loader:\n\tno available component selector!');
		return;
	}
	...
	var logicalScript = "//imgcache.qq.com/qcloud/main/scripts/release/qccomponent/index.e3bc4890e8b2cf5b7079.js?max_age=31536000";
